"""
Management command to create invoice email templates

NOTE: This command is now optional. The templates are created automatically via
data migration (0002_create_invoice_email_templates.py). You can still use this
command to update templates or recreate them if needed.
"""
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f'\nCompleted! Created {created_count} template(s), updated {updated_count} template(s).'
            )
        )
