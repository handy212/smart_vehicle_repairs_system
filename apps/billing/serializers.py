...
class EstimateDetailSerializer(QBOSyncFieldsMixin, serializers.ModelSerializer):
...
class CreditNoteDetailSerializer(QBOSyncFieldsMixin, serializers.ModelSerializer):
