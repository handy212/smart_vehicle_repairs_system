...
CONTROL_ACCOUNT_LABELS = {
    ...
    'salary_expense_account': 'Salary Expense',
    'overtime_expense_account': 'Overtime Expense',
    'allowances_expense_account': 'Allowances & Benefits Expense',
    'employer_statutory_expense_account': 'Employer Statutory Expense',
    'paye_tax_payable_account': 'PAYE Tax Payable',
    'payroll_deductions_payable_account': 'Payroll Deductions Payable',
    'employer_statutory_payable_account': 'Employer Statutory Payable',
}
...
CONTROL_ACCOUNT_GROUPS = {
    ...
    'salary_expense_account': 'Payroll',
    'overtime_expense_account': 'Payroll',
    'allowances_expense_account': 'Payroll',
    'employer_statutory_expense_account': 'Payroll',
    'paye_tax_payable_account': 'Payroll',
    'payroll_deductions_payable_account': 'Payroll',
    'employer_statutory_payable_account': 'Payroll',
}
...
def all_mapping_rows():
    ...
    for key, label in INVOICE_LINE_TYPE_LABELS.items():
        rows.append({
            ...
            'mapping_key': key,
            'label': label,
            'group': 'QBO classes — income (line type)',
            'uses_item': False,
            'uses_tax_code': False,
            'uses_class': True,
            'control_field': None,
