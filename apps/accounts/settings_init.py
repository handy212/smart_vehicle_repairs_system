...
DEFAULT_SETTINGS = {
    ...
    'sms': [
        ...
        {'key': 'hubtel_api_url', 'value': 'https://smsc.hubtel.com/v1/messages/send', 'description': 'Hubtel API URL'},
    ...
    'integration': [
        ...
        {'key': 'recaptcha_site_key', 'value': '', 'description': 'Google reCAPTCHA Site Key'},
        {'key': 'recaptcha_secret_key', 'value': '', 'description': 'Google reCAPTCHA Secret Key', 'is_secret': True},
        {'key': 'firebase_enabled', 'value': 'false', 'description': 'Enable Firebase Cloud Messaging'},
        {'key': 'firebase_api_key', 'value': '', 'description': 'Firebase API Key', 'is_secret': True},
        {'key': 'firebase_project_id', 'value': '', 'description': 'Firebase Project ID'},
        {'key': 'firebase_messaging_sender_id', 'value': '', 'description': 'Firebase Messaging Sender ID'},
        {'key': 'firebase_app_id', 'value': '', 'description': 'Firebase App ID'},
        {'key': 'firebase_credentials_path', 'value': '', 'description': 'Firebase service account path', 'is_secret': True},
        {'key': 'quickbooks_client_id', 'value': '', 'description': 'QuickBooks Online Client ID'},
        {'key': 'quickbooks_client_secret', 'value': '', 'description': 'QuickBooks Online Client Secret', 'is_secret': True},
        {'key': 'quickbooks_sandbox_enabled', 'value': 'true', 'description': 'Use QuickBooks sandbox'},
    ],
    'maintenance': [
