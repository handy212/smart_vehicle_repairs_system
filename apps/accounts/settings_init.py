...
DEFAULT_SETTINGS = {
    ...
    'sms': [
        ...
        {'key': 'infobip_base_url', 'value': '', 'description': 'Account-specific Infobip API base URL (for example, https://xxxxx.api.infobip.com)'},
        {'key': 'infobip_api_key', 'value': '', 'description': 'Infobip API key', 'is_secret': True},
        {'key': 'infobip_sender_id', 'value': '', 'description': 'Approved Infobip SMS sender name or number'},
        {'key': 'infobip_webhook_username', 'value': '', 'description': 'HTTP Basic username configured on the Infobip delivery subscription', 'is_secret': True},
        {'key': 'infobip_webhook_password', 'value': '', 'description': 'HTTP Basic password configured on the Infobip delivery subscription', 'is_secret': True},
