...
WORK_ORDER_STATES = [
    ...
    ('discontinued_pending_bill', 'Discontinued — Pending Invoice', '#ea580c', 'AlertTriangle'),
...
WORK_ORDER_TRANSITIONS = [
    ...
    ('inspection', 'discontinued_pending_bill', 'Discontinue Job', 'Discontinue'),
    ('intake', 'assigned', 'Assign Service Coordinator', 'Assign'),
    ('intake', 'discontinued_pending_bill', 'Discontinue Job', 'Discontinue'),
    ('assigned', 'diagnosis', 'Start Diagnosis', 'Start Diagnosis'),
    ('assigned', 'intake', 'Return to Intake', 'Return to Intake'),
    ('assigned', 'discontinued_pending_bill', 'Discontinue Job', 'Discontinue'),
    ('diagnosis', 'awaiting_approval', 'Request Approval', 'Request Approval'),
    ('diagnosis', 'paused', 'Pause Diagnosis', 'Pause Diagnosis'),
    ('diagnosis', 'discontinued_pending_bill', 'Discontinue Job', 'Discontinue'),
    ('awaiting_approval', 'approved', 'Approve Work Order', 'Approve'),
    ('awaiting_approval', 'diagnosis', 'Return to Diagnosis', 'Return to Diagnosis'),
    ('awaiting_approval', 'discontinued_pending_bill', 'Discontinue Job', 'Discontinue'),
    ('approved', 'in_progress', 'Start Repairs', 'Start Repairs'),
    ('approved', 'additional_work_found', 'Additional Work Found', 'Additional Work'),
    ('approved', 'discontinued_pending_bill', 'Discontinue Job', 'Discontinue'),
    ...
    ('in_progress', 'discontinued_pending_bill', 'Discontinue Job', 'Discontinue'),
    ('additional_work_found', 'awaiting_approval', 'Request Additional Approval', 'Request Approval'),
    ('additional_work_found', 'discontinued_pending_bill', 'Discontinue Job', 'Discontinue'),
    ('paused', 'diagnosis', 'Resume Diagnosis', 'Resume Diagnosis'),
    ('paused', 'in_progress', 'Resume Work', 'Resume'),
    ('paused', 'additional_work_found', 'Additional Work Found', 'Additional Work'),
    ('paused', 'discontinued_pending_bill', 'Discontinue Job', 'Discontinue'),
