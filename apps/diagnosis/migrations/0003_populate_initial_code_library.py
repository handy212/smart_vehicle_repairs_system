# Generated manually - Data migration to populate initial diagnostic code library
from django.db import migrations


def populate_code_library(apps, schema_editor):
    """Populate Diagnostic Code Library with common OBD-II codes"""
    DiagnosticCodeLibrary = apps.get_model('diagnosis', 'DiagnosticCodeLibrary')
...
def reverse_populate(apps, schema_editor):
    """Reverse migration - optionally remove codes"""
    # For safety, we don't delete codes in reverse migration
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('diagnosis', '0002_diagnosisfinding_diagnostictest_and_more'),
    ]

    operations = [
        migrations.RunPython(populate_code_library, reverse_populate),
    ]
