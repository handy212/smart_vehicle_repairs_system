                            ...
                            <Table>
                                <TableHeader className="bg-gray-50/50 dark:bg-gray-800/50 border-y border-gray-100 dark:border-gray-800">
                                    <TableRow className="hover:bg-transparent border-none">
                                        ...
                                        <TableHead className="h-9 text-[10px] uppercase tracking-wider font-semibold text-gray-500 px-4">Requested Date</TableHead>
                                        <TableHead className="h-9 text-[10px] uppercase tracking-wider font-semibold text-gray-500 px-4">Status</TableHead>
                                        <TableHead className="h-9 text-[10px] uppercase tracking-wider font-semibold text-gray-500 px-4 text-right">Items</TableHead>
