    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Card className="shadow-none border-none bg-gray-50/50">
                    <CardContent className="p-4 flex flex-col gap-1">
                        <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Total Services</span>
                        <div className="flex items-end justify-between">
                            <span className="text-2xl font-bold text-gray-900">{totalServices}</span>
                            <Wrench className="w-5 h-5 text-gray-400 mb-1" />
                        </div>
                    </CardContent>
                </Card>
                <Card className="shadow-none border-none bg-gray-50/50">
                    <CardContent className="p-4 flex flex-col gap-1">
                        <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Last Service</span>
                        <div className="flex items-end justify-between">
            ...
            <Card className="border-t shadow-sm">
                <CardHeader className="py-3 px-4 border-b bg-gray-50/30 flex flex-row items-center justify-between">
                    <CardTitle className="text-sm font-semibold text-gray-700">Service Records</CardTitle>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-gray-50/50 hover:bg-gray-50/50">
                                <TableHead className="w-[100px] px-4 h-10 text-[10px] uppercase tracking-wider font-semibold text-gray-500">WO #</TableHead>
                                ...
                                <TableHead className="px-4 h-10 text-[10px] uppercase tracking-wider font-semibold text-gray-500">Type</TableHead>
                                <TableHead className="px-4 h-10 text-[10px] uppercase tracking-wider font-semibold text-gray-500">Concerns</TableHead>
                                <TableHead className="px-4 h-10 text-[10px] uppercase tracking-wider font-semibold text-right text-gray-500">Amount</TableHead>
                                ...
                                sortedWorkOrders.map((wo) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell className="px-4 py-2 text-right font-medium text-sm text-gray-900">
