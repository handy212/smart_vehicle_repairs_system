...
export function InvoiceNotes({ invoice }: InvoiceNotesProps) {
    const [internalNotes, setInternalNotes] = useState(invoice.notes || "");
    ...
    const updateNotesMutation = useMutation({
        mutationFn: async (data: { notes?: string; customer_notes?: string }) => {
            return billingApi.invoices.update(invoice.id, data);
        },
        onSuccess: () => {
            toast({
                title: "Notes Updated",
                description: "Invoice notes have been saved successfully.",
                variant: "success",
            });
                    ...
                    <TabsContent value="customer">
                        <div className="space-y-2">
                            <Textarea
                                ...
                                placeholder="Add notes for the customer (e.g., Thank you for your business)..."
