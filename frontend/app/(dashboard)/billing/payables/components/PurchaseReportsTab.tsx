  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <p className="text-sm text-muted-foreground">AP cycle time and procure-to-pay compliance.</p>
        <BranchReportChip />
      </div>
      ...
      <Link href="/accounting/reports/aging" className="group inline-flex items-center gap-2 text-sm font-medium text-primary hover:underline">
        AP Aging Report
