    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        {summaryCards.map((card) => (
          <button key={card.key} type="button" onClick={() => setFilter(card.key)} className="text-left">
            <Card
              className={cn(
            ...
            >
              <CardContent className="pt-5">
                ...
                <p className="mt-1 text-2xl font-semibold">{formatCurrency(card.amount)}</p>
                <p className="mt-1 text-xs text-muted-foreground">{card.count} bills</p>
              </CardContent>
            </Card>
          </button>
        ))}
