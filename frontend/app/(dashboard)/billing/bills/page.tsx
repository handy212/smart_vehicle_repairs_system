...
export default function BillsPage() {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ["bills", page, search, advancedFilters, sortConfig, vendorFromUrl],
        queryFn: () => {
            ...
            return billingApi.bills.list({
                page,
                vendor: vendorFromUrl ? parseInt(vendorFromUrl, 10) : undefined,
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-muted/50 hover:bg-muted/50">
                                        ...
                                        {isQboConnected ? (
                                            <TableHead className="px-4 h-10 text-[10px] uppercase tracking-wider font-semibold text-muted-foreground">QBO</TableHead>
                                        ) : null}
                                            ...
                                            <TableCell className="px-4 py-2 text-right">
                                                <div className="flex items-center justify-end gap-1">
                                                    {canRecordPayment(bill) && (
                                                        ...
                                                        >
                                                            <Link
                                                                href={payBillsHref(bill.vendor, bill.id)}
