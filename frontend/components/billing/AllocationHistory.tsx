    ...
    if (isLoading) {
        return (
            <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                <p className="text-xs text-gray-500">Loading allocation history...</p>
            </div>
        );
    }
        ...
        return (
            <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-2 text-xs text-amber-600 bg-amber-50 dark:bg-amber-900/20 px-3 py-2 rounded-md">
                    ...
                    <span className="text-gray-600 dark:text-gray-400">- Payment not yet allocated to specific invoices</span>
                </div>
            </div>
        );
    }
        ...
        <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-2">
                {allocations.map((allocation) => (
                    <div
                        key={allocation.id}
                        className="bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-md p-3"
                    >
                        <div className="flex items-start justify-between">
                            <div className="flex-1">
                                ...
                                {allocation.notes && (
                                    <p className="text-xs text-gray-600 dark:text-gray-400 italic mt-2 pl-5">
                                        "{allocation.notes}"
                                    </p>
                                )}
                            </div>
